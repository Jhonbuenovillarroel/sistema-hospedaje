         ...
         <RoomDetails
            ...
            descriptionContent={
               <p className="mt-8 leading-7 md:leading-8">
                  ...
                  tiene vista a la calle, te sorprenderá con su comodidad y
                  encanto. <br /> <br /> Aquí encontrarás todo lo que necesitas
                  para una estancia relajante. La decoración acogedora y los
                  detalles cuidadosamente seleccionados crean un ambiente cálido
                  y acogedor. Después de un día de exploración en Jauja, podrás
                  ...
                  convierte en tu refugio personal. <br /> <br /> Además,
                  nuestra ubicación estratégica significa que estarás a solo
                  unos pasos de los lugares más emocionantes de Jauja. Desde el
                  momento en que entras por la puerta, te sumergirás en la
                  auténtica experiencia jaujina. Si buscas una opción de
