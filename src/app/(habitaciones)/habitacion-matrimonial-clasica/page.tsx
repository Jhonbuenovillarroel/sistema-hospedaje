         ...
         <RoomDetails
            ...
            descriptionContent={
               <p className="mt-8 leading-7 md:leading-8">
                  ...
                  alojamiento. Despiértate con la luz del sol que se filtra por
                  las ventanas y observa el mundo pasar mientras disfrutas de tu
                  café matutino. La Habitación con Vista a la Calle está
                  diseñada pensando en tu comodidad. Cuenta con una cama
                  espaciosa, un baño privado y todas las comodidades modernas
                  que necesitas. Este espacio es ideal para parejas que buscan
                  un retiro romántico o viajeros que valoran la comodidad.
                  Además, nuestra ubicación privilegiada significa que estarás a
                  pocos pasos de las atracciones más emocionantes de Jauja.
                  Cuando regreses después de un día de exploración, te espera un
                  oasis de tranquilidad en tu habitación. Si buscas una
                  experiencia de alojamiento memorable en Jauja, nuestra
                  Habitación con Vista a la Calle es la elección perfecta.
                  Disfruta de un espacio elegante, comodidades de primera clase
                  y la oportunidad de sumergirte en la vida vibrante de la
                  ciudad, todo a un precio excepcional.
               </p>
            }
            price={70}
            characteristics={[
